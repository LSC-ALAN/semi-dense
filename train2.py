...
def parse_args():
    ...
    # 这里直接提供默认值，避免使用 Bash 变量
    parser.add_argument('--data_cfg_path', type=str, default="configs/data/megadepth_trainval_832.py")
    parser.add_argument('--main_cfg_path', type=str, default="configs/jamma/outdoor/final.py")
    parser.add_argument('--exp_name', type=str, default='jamma')

    parser.add_argument('--batch_size', type=int, default=1)
    parser.add_argument('--num_workers', type=int, default=4)
    parser.add_argument('--pin_memory', type=lambda x: bool(strtobool(x)), default=True)
    ...
    # parser.add_argument(
    #     '--ckpt_path', type=str, default="/usr1/home/s124mdg51_07/JamMa/jamma_log/jamma/version_16/checkpoints/epoch=20-auc@5=0.633-auc@10=0.765-auc@20=0.857.ckpt",
    #     help='pretrained checkpoint path, helpful for using a pre-trained coarse-only LoFTR')
    parser.add_argument(
